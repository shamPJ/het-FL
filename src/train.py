...
def train(config, models, models_pooled, verbose=False, plot_preds=True, plot_w_dist=False):
    ...
    n_clusters, n_ds, n_samples, n_features    = config['n_clusters'], config['n_ds'], config['n_samples'], config['n_features']
    ...
    n_iters, regularizer_term = config['n_iters'], config['regularizer_term']
