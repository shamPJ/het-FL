...
def repeat_train(n_samples, config):
    ...
    for i in range(repeat_times):
        ...
        if adj_matrix:
            ...
            mse_train, mse_val, mse_val_pooled, est_weights, est_weights_pooled = train_no_A(G, G_pooled, n_neighbours=n_neighbours, n_neighbours_fixed=n_neighbours_fixed, n_iters=n_iters, regularizer_term=reg_term, m_shared=m_shared, parametric=parametric)
    ...
    return mse_train_array, mse_val_array, mse_val_pooled_array, est_error_array, est_error_pooled_array